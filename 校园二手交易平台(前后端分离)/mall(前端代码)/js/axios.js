	...
	return function(e) {
		...
		e.exports = {
			...
			merge: function e() {
				...
				function n(n, r) {
					u(t[r]) && u(n) ? t[r] = e(t[r], n) : u(n) ? t[r] = e({}, n) : i(n) ? t[
						r] = n.slice() : t[r] = n
				}
		...
		e.exports = function(e) {
			return new Promise((function(t, n) {
				...
				if (g.open(e.method.toUpperCase(), s(w, e.params, e
					...
					var S = (e.withCredentials || c(w)) && e.xsrfCookieName ? i
		...
		a.Axios = i, a.Cancel = n(2), a.CancelToken = n(26), a.isCancel = n(8), a.VERSION = n(10)
		...
		f.prototype.request = function(e) {
			"string" == typeof e ? (e = arguments[1] || {}).url = arguments[0] : e = e || {}, (
					e = a(this.defaults, e)).method ? e.method = e.method.toLowerCase() : this
				.defaults.method ? e.method = this.defaults.method.toLowerCase() : e.method =
				"get";
			...
			this.interceptors.request.forEach((function(t) {
				"function" == typeof t.runWhen && !1 === t.runWhen(e) || (r = r && t
					.synchronous, n.unshift(t.fulfilled, t.rejected))
			}));
			var o, i = [];
			if (this.interceptors.response.forEach((function(e) {
				...
				var f = [s, void 0];
				for (Array.prototype.unshift.apply(f, n), f = f.concat(i), o = Promise.resolve(
